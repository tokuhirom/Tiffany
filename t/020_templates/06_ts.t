...
{
    my $tmpl = Tfall::Template::Semantic->new('t/tmpl/foo.ts');
    is $tmpl->render({'#name' => 'john'}), qq{<html xmlns="http://www.w3.org/1999/xhtml">Hello, <div id="name">john</div>.</html>\n};
}
{
    my $tmpl = Tfall::Template::Semantic->new(\q{<html xmlns="http://www.w3.org/1999/xhtml">Hello, <div id="name">ben</div>.</html>});
    is $tmpl->render({'#name' => 'john'}), qq{<html xmlns="http://www.w3.org/1999/xhtml">Hello, <div id="name">john</div>.</html>\n};
}
